...
export interface IProductService {
  ...
  getBestSellers(query: ProductQueryDto): Promise<PaginatedResult<ProductResponseDto>>;
  getFeaturedProducts(
    query: ProductQueryDto,
  ): Promise<PaginatedResult<ProductResponseDto>>;
  getTopRatedProducts(
  ...
  searchProducts(query: ProductQueryDto): Promise<PaginatedResult<ProductResponseDto>>;
}
